...
var config = {
    ...
    emotions: [{
               ...
               type: 'image',
                ...
                {
                    alt: '[微笑]',
                    src: '/admin/lib/layui/images/face/0.gif'
                },
                {
                    alt: '[嘻嘻]',
                    src: '/admin/lib/layui/images/face/1.gif'
                },
                {
                    alt: '[哈哈]',
                    src: '/admin/lib/layui/images/face/2.gif'
                },
                {
                    alt: '[可爱]',
                    src: '/admin/lib/layui/images/face/3.gif'
                },
                {
                    alt: '[可怜]',
                    src: '/admin/lib/layui/images/face/4.gif'
                },
                {
                    alt: '[挖鼻]',
                    src: '/admin/lib/layui/images/face/5.gif'
                },
                {
                    alt: '[吃惊]',
                    src: '/admin/lib/layui/images/face/6.gif'
                },
                {
                    alt: '[害羞]',
                    src: '/admin/lib/layui/images/face/7.gif'
                },
                {
                    alt: '[挤眼]',
                    src: '/admin/lib/layui/images/face/8.gif'
                },
                {
                    alt: '[闭嘴]',
                    src: '/admin/lib/layui/images/face/9.gif'
                },
                {
                    alt: '[鄙视]',
                    src: '/admin/lib/layui/images/face/10.gif'
                },
                {
                    alt: '[爱你]',
                    src: '/admin/lib/layui/images/face/11.gif'
                },
                {
                    alt: '[泪]',
                    src: '/admin/lib/layui/images/face/12.gif'
                },
                {
                    alt: '[偷笑]',
                    src: '/admin/lib/layui/images/face/13.gif'
                },
                {
                    alt: '[亲亲]',
                    src: '/admin/lib/layui/images/face/14.gif'
                },
                {
                    alt: '[生病]',
                    src: '/admin/lib/layui/images/face/15.gif'
                },
                {
                    alt: '[太开心]',
                    src: '/admin/lib/layui/images/face/16.gif'
                },
                {
                    alt: '[白眼]',
                    src: '/admin/lib/layui/images/face/17.gif'
                },
                {
                    alt: '[右哼哼]',
                    src: '/admin/lib/layui/images/face/18.gif'
                },
                {
                    alt: '[左哼哼]',
                    src: '/admin/lib/layui/images/face/19.gif'
                },
                {
                    alt: '[嘘]',
                    src: '/admin/lib/layui/images/face/20.gif'
                },
                {
                    alt: '[衰]',
                    src: '/admin/lib/layui/images/face/21.gif'
                },
                {
                    alt: '[委屈]',
                    src: '/admin/lib/layui/images/face/22.gif'
                },
                {
                    alt: '[吐]',
                    src: '/admin/lib/layui/images/face/23.gif'
                },
                {
                    alt: '[哈欠]',
                    src: '/admin/lib/layui/images/face/24.gif'
                },
                {
                    alt: '[抱抱]',
                    src: '/admin/lib/layui/images/face/25.gif'
                },
                {
                    alt: '[怒]',
                    src: '/admin/lib/layui/images/face/26.gif'
                },
                {
                    alt: '[疑问]',
                    src: '/admin/lib/layui/images/face/27.gif'
                },
                {
                    alt: '[馋嘴]',
                    src: '/admin/lib/layui/images/face/28.gif'
                },
                {
                    alt: '[拜拜]',
                    src: '/admin/lib/layui/images/face/29.gif'
                },
                {
                    alt: '[思考]',
                    src: '/admin/lib/layui/images/face/30.gif'
                },
                {
                    alt: '[汗]',
                    src: '/admin/lib/layui/images/face/31.gif'
                },
                {
                    alt: '[困]',
                    src: '/admin/lib/layui/images/face/32.gif'
                },
                {
                    alt: '[睡]',
                    src: '/admin/lib/layui/images/face/33.gif'
                },
                {
                    alt: '[钱]',
                    src: '/admin/lib/layui/images/face/34.gif'
                },
                {
                    alt: '[失望]',
                    src: '/admin/lib/layui/images/face/35.gif'
                },
                {
                    alt: '[酷]',
                    src: '/admin/lib/layui/images/face/36.gif'
                },
                {
                    alt: '[色]',
                    src: '/admin/lib/layui/images/face/37.gif'
                },
                {
                    alt: '[哼]',
                    src: '/admin/lib/layui/images/face/38.gif'
                },
                {
                    alt: '[鼓掌]',
                    src: '/admin/lib/layui/images/face/39.gif'
                },
                {
                    alt: '[晕]',
                    src: '/admin/lib/layui/images/face/40.gif'
                },
                {
                    alt: '[悲伤]',
                    src: '/admin/lib/layui/images/face/41.gif'
                },
                {
                    alt: '[抓狂]',
                    src: '/admin/lib/layui/images/face/42.gif'
                },
                {
                    alt: '[黑线]',
                    src: '/admin/lib/layui/images/face/43.gif'
                },
                {
                    alt: '[阴险]',
                    src: '/admin/lib/layui/images/face/44.gif'
                },
                {
                    alt: '[怒骂]',
                    src: '/admin/lib/layui/images/face/45.gif'
                },
                {
                    alt: '[互粉]',
                    src: '/admin/lib/layui/images/face/46.gif'
                },
                {
                    alt: '[心]',
                    src: '/admin/lib/layui/images/face/47.gif'
                },
                {
                    alt: '[伤心]',
                    src: '/admin/lib/layui/images/face/48.gif'
                },
                {
                    alt: '[猪头]',
                    src: '/admin/lib/layui/images/face/49.gif'
                },
                {
                    alt: '[熊猫]',
                    src: '/admin/lib/layui/images/face/50.gif'
                },
                {
                    alt: '[兔子]',
                    src: '/admin/lib/layui/images/face/51.gif'
                },
                {
                    alt: '[ok]',
                    src: '/admin/lib/layui/images/face/52.gif'
                },
                {
                    alt: '[耶]',
                    src: '/admin/lib/layui/images/face/53.gif'
                },
                {
                    alt: '[good]',
                    src: '/admin/lib/layui/images/face/54.gif'
                },
                {
                    alt: '[NO]',
                    src: '/admin/lib/layui/images/face/55.gif'
                },
                {
                    alt: '[赞]',
                    src: '/admin/lib/layui/images/face/56.gif'
                },
                {
                    alt: '[来]',
                    src: '/admin/lib/layui/images/face/57.gif'
                },
                {
                    alt: '[弱]',
                    src: '/admin/lib/layui/images/face/58.gif'
                },
                {
                    alt: '[草泥马]',
                    src: '/admin/lib/layui/images/face/59.gif'
                },
                {
                    alt: '[神马]',
                    src: '/admin/lib/layui/images/face/60.gif'
                },
                {
                    alt: '[囧]',
                    src: '/admin/lib/layui/images/face/61.gif'
                },
                {
                    alt: '[浮云]',
                    src: '/admin/lib/layui/images/face/62.gif'
                },
                {
                    alt: '[给力]',
                    src: '/admin/lib/layui/images/face/63.gif'
                },
                {
                    alt: '[围观]',
                    src: '/admin/lib/layui/images/face/64.gif'
                },
                {
                    alt: '[威武]',
                    src: '/admin/lib/layui/images/face/65.gif'
                },
                {
                    alt: '[奥特曼]',
                    src: '/admin/lib/layui/images/face/66.gif'
                },
                {
                    alt: '[礼物]',
                    src: '/admin/lib/layui/images/face/67.gif'
                },
                {
                    alt: '[钟]',
                    src: '/admin/lib/layui/images/face/68.gif'
                },
                {
                    alt: '[话筒]',
                    src: '/admin/lib/layui/images/face/69.gif'
                },
                {
                    alt: '[蜡烛]',
                    src: '/admin/lib/layui/images/face/70.gif'
                },
                {
                    alt: '[蛋糕]',
                    src: '/admin/lib/layui/images/face/71.gif'
                }]}
        ,{
        // tab 的标题
            title: 'emoji',
