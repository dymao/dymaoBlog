...
public class ImageTokenUtil {
     ...
     * @throws IOException
     */
    public static void createImageToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        response.setHeader("Cache-Control", "no-store");
        response.setHeader("Pragma", "no-cache");
        response.setDateHeader("Expires", 0);
        response.setContentType("image/jpeg");
        String createText = generateVerifyCode(4);
        ...
        outputImage(IMAGE_WIDTH, IMAGE_HEIGHT, responseOutputStream,createText);
