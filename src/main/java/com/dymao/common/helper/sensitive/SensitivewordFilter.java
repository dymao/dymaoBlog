package com.dymao.common.helper.sensitive;
...
public class SensitivewordFilter {
	...
	public SensitivewordFilter(){
		...
		//sensitiveWordMap = new com.dymao.common.helper.sensitive.SensitiveWordInit().initKeyWord();
	}

	private void initSensitiveWordMap(){
		if(sensitiveWordMap == null){
			synchronized (this){
				List<String> list = sentiveWordMapper.findAll(new HashMap());
				if(list != null && !list.isEmpty()){
					Set<String> sets = new HashSet<String>(list);
					sensitiveWordMap = new SensitiveWordInit().initKeyWord(sets);
				}
			}
		}
	}
